...
NumPy, CuPy, PyTorch, Dask, JAX, MLX, ndonnx, Sparse and dpnp are supported. If you
want support for other array libraries, or if you encounter any issues, please
